...
while True:
	...
	SUBJECT = "Subject"
	TEXT = "One Visitor violated Face Mask Policy. See in the camera to recognize user. Please Alert the authorities."
	...
	for (box, pred) in zip(locs, preds):
		...
		if (label == "No Mask"):
			...
			mail.ehlo()
			mail.starttls()
			mail.login('pranav.mullapudi@gmail.com', 'Greenview08')
			mail.sendmail('pranav.mullapudi@gmail.com', 'pranav.mullapudi@gmail.com', message)
			mail.close()
		else:
			pass
			break
